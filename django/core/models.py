...
verbose_name_video_class = 'Vídeo'
...
class Video(models.Model):
    ...
    author = models.ForeignKey('auth.User', on_delete=models.PROTECT,
                               verbose_name='Autor', related_name='videos', editable=False)
    ...
    class Meta:
        verbose_name = verbose_name_video_class
...
class VideoMedia(models.Model):
    ...
    video_path = models.CharField(
        max_length=255, verbose_name=verbose_name_video_class)
    status = models.CharField(max_length=20, choices=Status.choices,
                              default=Status.UPLOADED_STARTED, verbose_name='Status')
    video = models.OneToOneField(
        'Video', on_delete=models.PROTECT, verbose_name=verbose_name_video_class, related_name='video_media')
